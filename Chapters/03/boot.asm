...
; ================================= Search loader.bin
					...
					MOV WORD [SectorNumber], SectorNumberOfRootDirectoryStart	; (DW)SectorNumber = 0, SectorNumberOfRootDirectoryStart = 19

SearchInRootDirectoryBegin:

					CMP WORD [RootDirectorySizeForLoop], 0				; (DW)RootDirectorySizeForLoop = RootDirectorySectors = 14
					JZ NoLoaderBin
...
SearchForLoaderBin:
					...
					JZ GoToNextSectorInRootDirectory
